...
**[Pénzügyi és vezetői számviteli környezet felépítése SAP-ban]{.ul}**

![C:\\Users\\Dr. Lendvai
Tamás\\AppData\\Local\\Microsoft\\Windows\\INetCache\\Content.MSO\\F2523EDB.tmp](fin\media\image1.png){width="6.3in"
height="4.191213910761155in"}
...
![C:\\Users\\Dr. Lendvai
Tamás\\AppData\\Local\\Microsoft\\Windows\\INetCache\\Content.MSO\\F3E398A1.tmp](fin\media\image2.png){width="5.875in"
...
![Képtalálatok a következőre: sap company group
structure](fin\media\image3.png){width="5.395833333333333in"
height="4.029032152230971in"}

1\. ábra Forrás:
http://sapmoduletutor.blogspot.com/2015/11/sap-mm-organizational-structure-in-sap.html
(2021. 02. 10.)

![Képtalálatok a következőre: sap company group
hierarchy](fin\media\image4.gif){width="5.0in" height="3.75in"}
...
![C:\\Users\\Dr. Lendvai
Tamás\\AppData\\Local\\Microsoft\\Windows\\INetCache\\Content.MSO\\A66B0457.tmp](fin\media\image5.png){width="6.3in"
height="3.948737970253718in"}

![Képtalálatok a következőre: thyssenkrupp word
map](fin\media\image6.jpeg){width="5.452723097112861in"
height="4.09375in"}

1\. ábra Forrás:
<https://www.slideshare.net/VishalHarichund/20150129tkiscompanypresentationtranen>
(2021. 02. 10.)

![Képtalálatok a következőre: sap word
map](fin\media\image7.png){width="6.3in" height="3.112795275590551in"}

2\. ábra SAP területi elhelyezkedése. Forrás:
<https://blogs.sap.com/2018/03/26/sap-labs-network-the-art-of-being-connected/>
(2021.02. 10.)

Az alábbi lista a világviszonylatban is meghatározó transznacionális
vállalatok egy részét tartalmazza.

![Képtalálatok a következőre: biggest companies continental
bosch](fin\media\image8.png){width="5.791666666666667in"
height="9.266666666666667in"}
...
![](fin\media\image9.png){width="4.271371391076116in"
...
![C:\\Users\\Dr. Lendvai
Tamás\\AppData\\Local\\Microsoft\\Windows\\INetCache\\Content.MSO\\B641C393.tmp](fin\media\image10.png){width="6.3in"
height="4.029405074365704in"}

![C:\\Users\\Dr. Lendvai
Tamás\\AppData\\Local\\Microsoft\\Windows\\INetCache\\Content.MSO\\F0F45619.tmp](fin\media\image11.png){width="6.3in"
height="3.9262871828521435in"}

![C:\\Users\\Dr. Lendvai
Tamás\\AppData\\Local\\Microsoft\\Windows\\INetCache\\Content.MSO\\F4CF388F.tmp](fin\media\image12.png){width="6.3in"
height="3.9614173228346456in"}
...
![C:\\Users\\Dr. Lendvai
Tamás\\AppData\\Local\\Microsoft\\Windows\\INetCache\\Content.MSO\\8DEA43F2.tmp](fin\media\image13.png){width="6.135416666666667in"
...
![C:\\Users\\Dr. Lendvai
Tamás\\AppData\\Local\\Microsoft\\Windows\\INetCache\\Content.MSO\\7B1B38D0.tmp](fin\media\image14.png){width="6.3in"
height="4.787999781277341in"}

**[Üzleti szegmens (Segment) / Szegmens riport (Segment report)]{.ul}**

![](fin\media\image15.png){width="6.291666666666667in"
height="3.71875in"}
...
![](fin\media\image16.png){width="5.822916666666667in"
...
![](fin\media\image17.png){width="6.291666666666667in"
height="3.71875in"}
...
![Képtalálatok a következőre: profit center organisation
sap](fin\media\image18.jpeg){width="6.3in" height="4.729937664041994in"}

<https://www.slideshare.net/bnanduri/profit-centeraccounting-50622317>
(2021. 02. 06.)
...
![](fin\media\image19.png){width="6.291666666666667in"
...
![](fin\media\image20.png){width="6.302083333333333in"
...
![http://saphelp.ucc.ovgu.de/NW750/EN/70/acd65378024308e10000000a174cb4/ppt_img.gif](fin\media\image21.gif){width="4.989583333333333in"
...
knitr::include_graphics("Bank_route.gif")
```
