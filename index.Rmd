...
![](intro\image2.png){width="6.291666666666667in"
height="3.8333333333333335in"}

![](intro\image3.png){width="6.291666666666667in"
height="3.3020833333333335in"}

![](intro\image4.png){width="6.291666666666667in"
...
![](intro\image5.png){width="4.547909011373578in"
height="4.020833333333333in"}

![](intro\image6.png){width="6.291666666666667in"
height="6.010416666666667in"}




<h2>**SAP számviteli felépítésének alapjai I.**</h2>
...
![](intro\2\image1.png){width="5.45123031496063in"
height="3.9375in"}
...
![](intro\2\image2.png){width="6.302083333333333in"
...
![](intro\2\image3.png){width="6.302083333333333in"
height="3.6875in"}
...
![](intro\2\image4.png){width="6.291666666666667in"
height="3.0625in"}
...
![](intro\2\image5.png){width="6.291666666666667in"
height="6.9375in"}
...
![](intro\2\image6.png){width="6.291666666666667in"
...
![](intro\2\image7.png){width="6.291666666666667in"
...
![](intro\2\image8.png){width="6.291666666666667in"
height="3.0625in"}
...
![](intro\2\image12.png){width="4.458333333333333in"
...
<h2>**[SAP használat alapjai]{.ul}**</h2>
...
![Képtalálatok a következőre: SAP
modules](intro_sapbasics\media\image1.jpeg){width="6.3in"
height="4.297182852143482in"}

. ábra Forrás: https://www.hipfunggroup.com/sap-erp-system/ (2021. 02.
10.)
...
![](intro_sapbasics\media\image2.png){width="6.302083333333333in"
...
![](intro_sapbasics\media\image3.png){width="6.302083333333333in"
height="0.78125in"}

**[AIS_APAY_CLERK_US00 Szállítói számla könyvelő]{.ul}**

![](intro_sapbasics\media\image4.png){width="6.291666666666667in"
height="2.6770833333333335in"}

**[Role VS:: AIS_AR_CLERK_US00 Vevői számla könyvelő]{.ul}**

![](intro_sapbasics\media\image5.png){width="6.302083333333333in"
height="2.6770833333333335in"}

**[Role VS::FI_AA_ASSET_TRANSACTIONS Tárgyi eszköz könyvelő]{.ul}**

![](intro_sapbasics\media\image6.png){width="6.291666666666667in"
height="4.4375in"}
...
![](intro_sapbasics\media\image7.png){width="6.3in"
...
![](intro_sapbasics\media\image8.png){width="6.302083333333333in"
height="3.4791666666666665in"}

. ábra Saját szerkesztés (Lendvai Tamás)
...
![](intro_sapbasics\media\image9.png){width="6.302083333333333in"
height="0.71875in"}
...
![](intro_sapbasics\media\image10.png){width="6.302083333333333in"
height="2.5625in"}

![](intro_sapbasics\media\image11.png){width="3.441626202974628in"
height="1.7291666666666667in"}

![](intro_sapbasics\media\image12.png){width="4.083333333333333in"
...
knitr::include_graphics("intro_gif/Bank_route.gif")
```


**Az elérhető tranzakciók közül az alábbiak használatát tekintjük át.**

![](intro_sapbasics\media\image13.png){width="6.291666666666667in"
height="1.0in"}
...
![](intro_sapbasics\media\image14.png){width="2.409448818897638in"
height="1.125in"}

Ezt követően értelemszerűen töltsük ki az űrlapot.

![](intro_sapbasics\media\image15.png){width="6.3in"
...
![](intro_sapbasics\media\image16.png){width="2.2916666666666665in"
height="0.4583333333333333in"}

**FI02 - Módosítás**

![](intro_sapbasics\media\image17.png){width="6.302083333333333in"
height="1.0in"}

```{r,dpi=50,fig.align='center'}
knitr::include_graphics("intro_gif/FI02_Change.gif")
```
...
![](intro_sapbasics\media\image18.png){width="6.291666666666667in"
height="1.03125in"}

```{r,dpi=50,fig.align='center'}
knitr::include_graphics("intro_gif/FI03_Display.gif")
```


**FI04 Változások egyedi megtekintése (Display Changes)**

![](intro_sapbasics\media\image19.png){width="6.291666666666667in"
height="1.0520833333333333in"}

```{r,dpi=50,fig.align='center'}
knitr::include_graphics("intro_gif/FI04_Display_Changes.gif")
```
...
![](intro_sapbasics\media\image20.png){width="6.291666666666667in"
height="1.1041666666666667in"}


```{r,dpi=50,fig.align='center'}
knitr::include_graphics("intro_gif/S_P00_07000008_Display_of_Bank_Changes.gif")
```
...
![](intro_sapbasics\media\image21.png){width="6.302083333333333in"
height="1.03125in"}


```{r,dpi=50,fig.align='center'}
knitr::include_graphics("intro_gif/Display_Bank_Directory.gif")
```
